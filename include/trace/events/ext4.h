...
/* Generate stubs for now */
#define	__field(type,item)
#define	TP_PROTO(x)	x
#define	TP_PROTO2(x,y)	x,y
#define	TP_PROTO3(x,y,z)	x,y,z
#define	TP_PROTO4(a,b,c,d)	a,b,c,d
#define	TP_PROTO5(a,b,c,d,e)	a,b,c,d,e
#define	DEFINE_EVENT(e,fn,proto,args)
#define	DECLARE_EVENT_CLASS(call, proto, args, tstruct, assign, print)
#define	TRACE_EVENT(fn,proto,args,pk) static __inline void trace_##fn(proto) { /* */ }
...
TRACE_EVENT(ext4_request_inode,
	TP_PROTO2(struct inode *dir, int mode),
...
TRACE_EVENT(ext4_allocate_inode,
	TP_PROTO3(struct inode *inode, struct inode *dir, int mode),
...
DECLARE_EVENT_CLASS(ext4__write_begin,
	...
	TP_PROTO4(struct inode *inode, loff_t pos, unsigned int len,
		 unsigned int flags),
...
TRACE_EVENT(ext4_writepage,
	TP_PROTO2(struct inode *inode, struct page *page),
...
TRACE_EVENT(ext4_da_writepages,
	TP_PROTO2(struct inode *inode, struct writeback_control *wbc),
...
TRACE_EVENT(ext4_da_write_pages,
	TP_PROTO2(struct inode *inode, struct mpage_da_data *mpd),
...
TRACE_EVENT(ext4_da_writepages_result,
	TP_PROTO4(struct inode *inode, struct writeback_control *wbc,
...
TRACE_EVENT(ext4_discard_blocks,
	TP_PROTO3(struct super_block *sb, unsigned long long blk,
...
TRACE_EVENT(ext4_mb_new_inode_pa,
	TP_PROTO2(struct ext4_allocation_context *ac,
...
TRACE_EVENT(ext4_mb_release_inode_pa,
	TP_PROTO5(struct super_block *sb,
...
TRACE_EVENT(ext4_mb_release_group_pa,
	TP_PROTO3(struct super_block *sb,
		 struct ext4_allocation_context *ac,
		 struct ext4_prealloc_space *pa),
...
TRACE_EVENT(ext4_mb_discard_preallocations,
	TP_PROTO2(struct super_block *sb, int needed),
...
TRACE_EVENT(ext4_allocate_blocks,
	TP_PROTO2(struct ext4_allocation_request *ar, unsigned long long block),
...
TRACE_EVENT(ext4_free_blocks,
	TP_PROTO4(struct inode *inode, __u64 block, unsigned long count,
			int metadata),
...
TRACE_EVENT(ext4_sync_file,
	TP_PROTO3(struct file *file, struct dentry *dentry, int datasync),
...
TRACE_EVENT(ext4_sync_fs,
	TP_PROTO2(struct super_block *sb, int wait),
